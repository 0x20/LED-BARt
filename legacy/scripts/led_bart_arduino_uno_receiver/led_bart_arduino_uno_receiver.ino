// LED-BARt Arduino Uno Receiver
// Receives display data from D1 Mini via Serial and controls 5V LED bar
...
// Display buffer - stores the current text to display
...
void setup() {
  // Initialize serial communication with D1 Mini
  Serial.begin(115200);
  ...
  // Default text
  strcpy((char*)tekst, "10:09 24/05  16.5~C");
  tekstLength = 19;
